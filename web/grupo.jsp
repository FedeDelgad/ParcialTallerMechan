<%-- 
    Document   : grupo
    Created on : 03/03/2022, 10:21:45 AM
    Author     : hp
--%>
...
<html>
    ...
    <div class="container mt-3">
        ...
        <a href="controldisco.jsp?accion=listargrupo&idgrupo=${g.getIdgrupo()}" style="text-decoration: none">
            ...
            <div class="card-body pl-1 pr-1 text-center" > 
                 <div  class=" text-white tit1" style="font-size:28px">${g.getNombregrupo()}</div>
              </div>
          </div>
         </a>
        </c:forEach>
