<%-- 
    Document   : disco3
    Created on : 05/03/2022, 09:08:34 AM
    Author     : hp
--%>
...
<html>
    ...
    <section class="d-flex  men-1"> 
      <div class="formulario p-2 pt-3 ">
        <div class="card pb-2 " style="width: 26rem;">
          <div class="card-body mt-3">
            <h5 class="card-title mb-4"><i class="fa-solid fa-headphones-simple"></i> Nuevo Genero</h5>
            <form action="controlgenero.jsp" method="post">
            ...
            <input  type="hidden" id="msj1" value="${gen}">
          </div>
        </div>
     </div>
        <div class="tabla p-3"> 
           <table class="table" id="datatable">
              <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col" style="padding-right: 130px">GENEROS</th>
                  <th scope="col" >ACCIONES</th>
                </tr>
              </thead>
              <tbody>
               <c:forEach var="g" items="${generos1}"> 
                <tr>
               
               
                  <td>${g.getGenero()}</td>
                  <td  style="  ">
                    <a class="btn btn-warning text-white " style="font-size: 17px" id="actualizar" data-toggle="modal" data-target="#nuevo2${g.getIdgenero()}"><i class="fas fa-edit"></i></a>  
                      
                      <div class="modal fade" id="nuevo2${g.getIdgenero()}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content col-sm-10 p-0">
                                    <div class="modal-header mod-h p-3 ">
                                      <h4 class="modal-title   mt-4 mb-2 ml-3  " id="exampleModalLabel"><i class="fa-solid fa-users"></i> Modificar Genero</h4>
                                      <div style="border: none" class="close   mr-2" data-dismiss="modal" aria-label="Close">
                                        &times;
                                      </div>

                                    </div>
                                      <form action="controlgenero.jsp" class="p-4 mt-2 "  method="post">
                                          <input name="idgenero1" type="hidden" value="${g.getIdgenero()}">
                                          <div class="form-group">
                                              <label  style=" text-align: left" for="formGroupExampleInput">Genero</label>
                                            <input type="text" name="genero1" class="form-control" id="formGroupExampleInput" value="${g.getGenero()}">
                                          </div>
                     ...
                     <input type="hidden" id="idgenero" value="${g.getIdgenero()}">
                     <a href="#" id="btneliminar" class="btn btn-danger text-white ml-1" style="font-size: 17px"><i class="fas fa-trash-alt"></i></a>
      ...
      <input  type="hidden" id="msj2" value="${gen1}">
