<%-- 
    Document   : genero
    Created on : 03/03/2022, 12:14:57 PM
    Author     : hp
--%>
...
<html>
    ...
    <div class="container mt-3">
        ...
        <c:forEach var="g" items="${generos}">  
          <a href="controldisco.jsp?accion=listargenero&idgenero=${g.getIdgenero()}" style="text-decoration: none">
            ...
            <div class="card-body pl-1 pr-1 text-center" > 
                 <div  class=" text-white tit1" style="font-size:28px"> ${g.getGenero()}</div>
              </div>
          </div>
         </a>
        </c:forEach>
